# 📋DAY 3 TASK: "Todo Manager" App with Performance Optimization
...
o Memoize the filtered list of todos (e.g., Completed / Pending).
...
o Handles reducer, adding, toggling, removing todos.
